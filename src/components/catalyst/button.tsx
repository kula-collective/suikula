...
) & { className?: string; disabled?: boolean; loading?: boolean; children: React.ReactNode } & (
...
export const Button = forwardRef(function Button(
  ...
  return 'href' in props ? (
    ...
    <Headless.Button {...props} disabled={disabled || loading} className={clsx(classes, 'cursor-default')} ref={ref}>
      <span hidden={!loading}>
