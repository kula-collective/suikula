...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const computedCurrent = current ?? pathname === path;
  let classes = clsx(
    // Base
    ...
    // Current
    "data-[slot=icon]:*:data-[computedCurrent]:fill-zinc-950",
    // Dark mode
    "dark:text-white dark:data-[slot=icon]:*:fill-zinc-400",
    "dark:data-[hover]:bg-white/5 dark:data-[slot=icon]:*:data-[hover]:fill-white",
    "dark:data-[active]:bg-white/5 dark:data-[slot=icon]:*:data-[active]:fill-white",
    "dark:data-[slot=icon]:*:data-[computedCurrent]:fill-white"
  );
      ...
      {"href" in props ? (
        <Headless.CloseButton as={Fragment} ref={ref}>
          <Link
            className={classes}
            {...props}
            data-current={computedCurrent ? "true" : undefined}
          >
